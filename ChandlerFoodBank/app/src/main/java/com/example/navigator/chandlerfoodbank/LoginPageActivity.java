...
public class LoginPageActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Toast.makeText(LoginPageActivity.mContext," succesfully Logged in", Toast.LENGTH_SHORT).show();
                finish();
                newIntent = new Intent(LoginPageActivity.mContext,HomePageActivity.class);
